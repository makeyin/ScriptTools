sed -i "/network_address/ s/127.0.0.1/115.231.82.177/g" ./configs/config.toml
sed -i "s|http://127.0.0.1:1317|https://rest-tropos.thestratos.org:443|g" ./configs/config.toml
